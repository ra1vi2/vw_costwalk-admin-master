		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cost Walk Administration",
									"targetURL": "#managecwadmincostwalkadmin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"managecwadmincostwalkadmin-display": {
								"semanticObject": "managecwadmincostwalkadmin",
								"action": "display",
								"description": "A Fiori application.",
								"title": "Cost walk for Admin",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=manage.cw.admin.costwalkadmin",
									"url": sap.ui.require.toUrl("manage/cw/admin/costwalkadmin")
								}
							}
						}
					}
